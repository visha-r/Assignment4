...
public class Bz2WikiParser {
	...
	private static List<String> linkPageNames = new LinkedList<>();
	...
	public static Node parseLine (String line) {
		...
		try {
			if (line != null) {
				...
				count +=1;
				//System.out.println("Hello " + pageName +"  ----" + linkPageNames.toString());
	...
	static class WikiParser extends DefaultHandler {
